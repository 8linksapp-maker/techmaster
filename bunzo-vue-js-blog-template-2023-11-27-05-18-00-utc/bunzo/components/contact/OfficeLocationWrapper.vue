                    ...
                    <div class="border-2 border-[#f4f4f4] rounded-xl p-8 mt-8">
                        <div class="space-y-5">
                            ...
                            <div class="flex items-center">
                                ...
                                <a href="mailto:example@mail.com" class="hover:text-primary">example@mail.com</a>
                            </div>
                            <div class="flex items-center">
                                <div class="w-12 h-12 flex-shrink-0 rounded-md bg-[#f4f4f4] text-center mr-4 text-heading-light flex justify-center items-center">
                        ...
                        <div class="social mt-8">
                            ...
                            <div class="flex mt-3 space-x-2">
                                <SocialIcon url="https://www.facebook.com" icon="icofont-facebook" />
                                <SocialIcon url="https://twitter.com" icon="icofont-twitter" />
