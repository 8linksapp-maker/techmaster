<template>
    <div class="privacy-policy">
        <Breadcrumb slug="Privacy Policy" />

        <!-- privacy policy content start -->
        <section class="py-section">
            <div class="container">
                <div class="mb-8">
                    <h3 class="mb-2">Who we are ?</h3>
                    <p>Our website address is: <a href="http://hasthemes.com">http://hasthemes.com</a></p>
                </div>
                <div class="mb-8">
                    <h3 class="mb-2">What personal data we collect and why we collect it comments</h3>
